#!/usr/bin/env bash
# ==============================================================================
# One-Command Binary Installer for Instagram Desktop (Arch Linux / Manjaro)
# Installs pre-built binary packages without requiring build tools or compilers.
# ==============================================================================
set -e

REPO="rootLocalGhost/Instagram-Next"
APP_NAME="Instagram Desktop"
BIN_NAME="instagram-desktop"
...
[Desktop Entry]
Name=Instagram
Comment=Official Instagram Web Desktop Client with Native Notifications
Exec=/usr/local/bin/${BIN_NAME} %U
Icon=${BIN_NAME}
Terminal=false
Type=Application
Categories=Network;InstantMessaging;Chat;Social;
StartupWMClass=instagram-desktop
MimeType=x-scheme-handler/instagram;
Keywords=Instagram;Social;Photos;Direct;Messages;Reels;
EOF
    fi
